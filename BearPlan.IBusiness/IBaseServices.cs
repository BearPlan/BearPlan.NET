...
public interface IBaseServices<TEntity> where TEntity : class
{
    ...
    /// <returns></returns>
    Task<int> AddAsync(TEntity entity, string lockString = "");
    ...
    /// <param name="lockString">锁</param>
    /// <returns></returns>
    Task<int> AddAsync(List<TEntity> entitys, string lockString = "");
    ...
    /// <returns></returns>
    Task<int> UpdateAsync(Expression<Func<TEntity, bool>> where,
    ...
    /// <param name="lockString">锁</param>
    /// <returns></returns>
    Task<int> UpdateAsync(TEntity entity, Expression<Func<TEntity, object>> isUpdateColumns = null,
    ...
    /// <param name="lockString">锁</param>
    /// <returns></returns>
    Task<int> UpdateAsync(List<TEntity> entitys, Expression<Func<TEntity, object>> isUpdateColumns = null,
        Expression<Func<TEntity, object>> ignoreColumns = null, bool isIgnoreNull = true, string lockString = "");
    ...
    /// <returns></returns>
    Task<int> LogicDeleteAsync<T>(Expression<Func<T, bool>> exp) where T : class, ISoftDeletedEntity, new();
    ...
    /// <returns></returns>
    ISugarQueryable<TEntity> GetIQueryable(Expression<Func<TEntity, bool>> whereExpression = null,
