...
namespace BearPlan.Entity.ConfigProvider
{
    ...
    public class TableColumn
    {
        ...
        /// 字段描述
        /// </summary>
        public string ColumnTypeDetail { get; set; } = string.Empty;
        /// <summary>
        /// 字段验证
        /// </summary>
        public string ColumnTypeRules { get; set; } = string.Empty;
        ...
        /// 头部多余参数 
        /// </summary>
        public string HeadAttrsString { get; set; } = string.Empty;
        /// <summary>
        ///  是否选中
        /// </summary>
