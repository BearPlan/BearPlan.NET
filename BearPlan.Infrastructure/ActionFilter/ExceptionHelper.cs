...
public static class ExceptionHelper
{
    ...
    /// <returns></returns>
    public static string ErrorFormat(HttpContext httpContext, string remoteIp, string ipAddress, Exception exception,
        ...
        string operatingSystem, string deviceType, string browserName, string version)
    {
        return string.Format("\r\n【异常信息】 : {0} \r\n" +
            ...
            Core.Helper.ExceptionHelper.GetExceptionAllMsg(exception));
    }
}
